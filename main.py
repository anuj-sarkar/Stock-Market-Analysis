...
tab1.table(data.tail())

data1=data;
data=data.reset_index()

tab2.subheader('Stock closing price with Time Period Selector')
...
st.subheader("Analysed Data Description")
st.table(data1.describe().drop(['count','25%','50%','75%'],axis=0))
